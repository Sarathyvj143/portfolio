...
export default class ArticleItemDataWrapper {
    ...
    constructor(articleDataWrapper, rawData, language, theme, id) {
        ...
        this._rawData = rawData // Store the original raw data

        this.id = id
        this.categoryId = rawData.categoryId
        this.category = undefined

        // Preserve the blogData property directly on the instance
        // This is crucial for blog navigation
        if (rawData.blogData) {
            this.blogData = JSON.parse(JSON.stringify(rawData.blogData));
            console.log("Preserving blogData in ArticleItemDataWrapper:", this.blogData);
        }
